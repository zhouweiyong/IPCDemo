...
public class SameProcessActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_same_process);
        initView();
    ...
    private void initView() {
        ...
        adapter = new ArrayAdapter<String>(SameProcessActivity.this, android.R.layout.activity_list_item, android.R.id.text1, list);
